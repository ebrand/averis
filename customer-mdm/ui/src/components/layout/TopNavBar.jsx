...
export const TopNavBar = ({ onMenuToggle, isSidebarOpen }) => {
  ...
  return (
    <nav className="bg-red-700 shadow-sm border-b border-red-800 fixed top-0 left-0 right-0 z-50">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center w-80 flex-shrink-0">
            <button
              ...
              className="p-2 rounded-md text-white hover:text-gray-100 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-red-500 lg:hidden"
            >
            ...
            <div className="flex items-center ml-4 lg:ml-0">
              ...
              <div className="ml-3">
                <h1 className="text-lg font-semibold text-white">Averis Customer</h1>
                <p className="text-xs text-red-100 hidden sm:block">Customer Relationship Management</p>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSearchSubmit} className="w-full">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-2 border border-red-600 rounded-md leading-5 bg-red-600 placeholder-red-100 text-white focus:outline-none focus:placeholder-red-50 focus:ring-1 focus:ring-red-500 focus:border-red-500 sm:text-sm"
                  placeholder="Search customers, accounts, prospects..."
                  type="search"
                />
              </div>
            </form>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-lg text-white hover:text-gray-100 hover:bg-red-600 transition-colors"
            ...
            {isAuthenticated && userProfile ? (
              <div className="relative" ref={profileMenuRef}>
                <button
                  ...
                  className="flex items-center space-x-3 px-3 py-2 w-[250px] bg-red-600 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 focus:ring-offset-red-700 hover:bg-red-500"
                >
