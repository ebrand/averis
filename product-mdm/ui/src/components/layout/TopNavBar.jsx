...
export const TopNavBar = ({ onMenuToggle, isSidebarOpen }) => {
  ...
  return (
    <nav className="bg-blue-800 shadow-sm border-b border-blue-900 fixed top-0 left-0 right-0 z-50">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center w-80 flex-shrink-0">
            <button
              ...
              className="p-2 rounded-md text-white hover:text-blue-200 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-600 lg:hidden"
            >
            ...
            <div className="flex items-center ml-4 lg:ml-0">
              ...
              <div className="ml-3">
                <h1 className="text-lg font-semibold text-white">Averis Product</h1>
                <p className="text-xs text-blue-200 hidden sm:block">Master Data Management</p>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSearchSubmit} className="w-full">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-2 border border-blue-600 rounded-md leading-5 bg-blue-700 placeholder-blue-300 text-white focus:outline-none focus:placeholder-blue-200 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-lg text-white hover:text-blue-200 hover:bg-blue-700 transition-colors"
            ...
            {isAuthenticated && userProfile ? (
              <div className="relative" ref={profileMenuRef}>
                <button
                  ...
                  className="flex items-center space-x-3 px-3 py-2 w-[250px] bg-blue-700 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600 focus:ring-offset-blue-800 hover:bg-blue-600"
                >
