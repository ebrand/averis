...
import { navigateToApp, navigateToDashboard, navigateToPricingMdm, navigateToCustomerMdm } from '../../utils/crossAppNavigation'
import {
  HomeIcon,
  CubeIcon,
  TagIcon,
...
export const SideNavBar = ({ isOpen, onClose }) => {
  ...
  const getInitialExpandedSections = () => {
    ...
    // Default: always open Products section for new users  
  ...
  const navigation = [
    ...
    ...(canAccessAdminFeatures() ? [{
      ...
      children: [
        ...
        { name: 'Staging View', href: '/products/staging' },
        { name: 'Message Log', href: '/products/messages' }
      ]
    }] : [])
  ]
  ...
  const NavItem = ({ item, isChild = false, isExpanded, onToggle }) => {
    ...
    // Custom active check for "All Products" - consider both "/" and "/products" as active
      ...
      >
        <div className="flex h-full flex-col">
          ...
          <div className="border-b border-gray-200 dark:border-gray-700 px-4 py-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Product data mgmt</p>
          </div>
            ...
            <div className="grid grid-cols-3 gap-2">
              {platformApps.map((app, index) => {
                ...
                const gridClass = app.size === 'large' 
                  ? 'col-span-2 row-span-1' // Product button spans 2 columns
