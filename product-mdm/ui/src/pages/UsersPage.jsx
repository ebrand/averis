...
const UsersPage = () => {
  ...
  const getRoleBadgeColor = (role) => {
    const colors = {
      ...
      'product_legal': 'bg-blue-100 text-blue-800',
      ...
      'user_admin': 'bg-blue-900 text-white'
    }
      ...
      <div className="mt-6 flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex items-center">
          <label className="flex items-center cursor-pointer">
            ...
            />
            <div className="relative">
              <div className={`block w-14 h-8 rounded-full transition-colors ${showInactive ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-600'}`}></div>
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex flex-wrap gap-1">
                            {user.roles.filter(role => role !== 'product_pdm' && role !== 'averis_product').map((role, index) => (
                              <span
                                key={index}
            ...
            <div className="mt-3">
              ...
              <div className="mt-6 flex justify-end space-x-3">
                <button
                  ...
                  className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
                >
                  Cancel
                </button>
                <button
