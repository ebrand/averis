  ...
  const features = [
    {
      ...
      description: 'Centralized product catalog with comprehensive data management'
    },
    {
      icon: ChartBarIcon,
      title: 'Analytics & Insights',
      description: 'Advanced reporting and business intelligence for product data'
    },
    {
      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div className="text-center px-2 mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900">aVeris Product</h1>
        ...
        <div className="relative h-full flex flex-col justify-center px-12">
          <div className="text-center text-white mb-12">
            ...
            <p className="text-xl text-blue-100">
              Streamline your product operations with comprehensive data management tools
            </p>
          </div>
