    ...
    const loadProduct = async () => {
      try {
        ...
        const mappedData = {
          ...
          marketingApproved: Boolean(productData.marketingApproved),
          marketingApprovedBy: productData.marketingApprovedBy || null,
          marketingApprovedAt: productData.marketingApprovedAt || null,
          legalApproved: Boolean(productData.legalApproved),
          legalApprovedBy: productData.legalApprovedBy || null,
          legalApprovedAt: productData.legalApprovedAt || null,
          financeApproved: Boolean(productData.financeApproved),
          financeApprovedBy: productData.financeApprovedBy || null,
          financeApprovedAt: productData.financeApprovedAt || null,
          salesopsApproved: Boolean(productData.salesopsApproved),
          salesopsApprovedBy: productData.salesopsApprovedBy || null,
          salesopsApprovedAt: productData.salesopsApprovedAt || null,
          contractsApproved: Boolean(productData.contractsApproved),
          contractsApprovedBy: productData.contractsApprovedBy || null,
          contractsApprovedAt: productData.contractsApprovedAt || null,
          
          // Product launch fields
          launchedBy: productData.launchedBy || null,
