  ...
  async getFilteredProducts(searchQuery = '', filters = {}, page = 1, limit = 20) {
    try {
      ...
      return {
        ...
        pagination: {
          ...response.pagination,
          pages: response.pagination.totalPages,  // Map totalPages to pages for UI compatibility
          total: response.pagination.totalItems  // Map totalItems to total for UI compatibility
        },
        error: null
      }
    } catch (error) {
