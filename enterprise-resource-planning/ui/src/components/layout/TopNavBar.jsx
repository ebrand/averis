...
export const TopNavBar = ({ onMenuToggle, isSidebarOpen }) => {
  ...
  const handleSearchSubmit = (e) => {
    e.preventDefault()
    if (searchQuery.trim()) {
      // Navigate to main dashboard with search query
      navigate(`/?search=${encodeURIComponent(searchQuery.trim())}`)
    } else if (location.pathname !== '/') {
      // If no search query, just go to main dashboard
      navigate('/')
    }
  }
  ...
  return (
    <nav className="bg-orange-800 shadow-sm border-b border-orange-900 fixed top-0 left-0 right-0 z-50">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center w-80 flex-shrink-0">
            <button
              ...
              className="p-2 rounded-md text-white hover:text-orange-200 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-orange-600 lg:hidden"
            >
            ...
            <div className="flex items-center ml-4 lg:ml-0">
              ...
              <div className="ml-3">
                <h1 className="text-lg font-semibold text-white">Averis ERP</h1>
                <p className="text-xs text-orange-200 hidden sm:block">Inventory & Accounting Management</p>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSearchSubmit} className="w-full">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-2 border border-orange-600 rounded-md leading-5 bg-orange-700 placeholder-orange-300 text-white focus:outline-none focus:placeholder-orange-200 focus:ring-1 focus:ring-orange-500 focus:border-orange-500 sm:text-sm"
                  placeholder="Search inventory, accounts, suppliers..."
                  type="search"
                />
              </div>
            </form>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-lg text-white hover:text-orange-200 hover:bg-orange-700 transition-colors"
            ...
            {isAuthenticated && userProfile ? (
              <div className="relative" ref={profileMenuRef}>
                <button
                  ...
                  className="flex items-center space-x-3 px-3 py-2 w-[250px] bg-orange-700 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-600 focus:ring-offset-orange-800 hover:bg-orange-600"
                >
