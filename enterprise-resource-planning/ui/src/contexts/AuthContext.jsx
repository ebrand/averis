...
export const AuthProvider = ({ children }) => {
  ...
  const initializeAuth = async () => {
    try {
      ...
      console.log('Enterprise Resource Planning AuthContext: initializeAuth starting')
      console.log('Enterprise Resource Planning AuthContext: Logout URL parameter:', logoutParam)
      
      // If logout parameter exists, FORCE logout immediately regardless of other state
      if (logoutParam) {
        console.log('Enterprise Resource Planning AuthContext: FORCED LOGOUT - Logout parameter detected, clearing all session data')
        ...
        // Clean up the URL
        console.log('Enterprise Resource Planning AuthContext: Cleaning logout parameter from URL')
        const cleanUrl = window.location.origin + window.location.pathname
        window.history.replaceState({}, document.title, cleanUrl)
        
        setIsLoading(false)
        console.log('Enterprise Resource Planning AuthContext: FORCED LOGOUT COMPLETE - staying logged out')
        return
      }
      ...
      console.log('Enterprise Resource Planning AuthContext: Comprehensive logout detection:', { 
        recentLogout, 
        forcedLogout, 
        permanentLogout,
      ...
      if (recentLogout || forcedLogout || permanentLogout) {
        console.log('Enterprise Resource Planning AuthContext: LOGOUT DETECTED - preventing authentication restoration')
        ...
        setIsLoading(false)
        console.log('Enterprise Resource Planning AuthContext: LOGOUT PREVENTION COMPLETE - staying logged out')
        return
      }
