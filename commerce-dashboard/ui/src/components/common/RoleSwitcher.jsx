  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center justify-between px-3 py-2 rounded-lg bg-teal-700 border border-teal-600 hover:border-teal-500 transition-colors w-[250px]"
      >
        ...
        <ChevronDownIcon className="h-4 w-4 text-teal-300 mr-1" />
      </button>
