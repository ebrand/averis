...
export const TopNavBar = ({ onMenuToggle, isSidebarOpen }) => {
  ...
  return (
    <nav className="bg-teal-600 shadow-sm border-b border-teal-700 fixed top-0 left-0 right-0 z-50">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center w-80 flex-shrink-0">
            <button
              ...
              className="p-2 rounded-md text-white hover:text-teal-100 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-teal-500 lg:hidden"
            >
            ...
            <div className="flex items-center ml-4 lg:ml-0">
              ...
              <div className="ml-3">
                <h1 className="text-lg font-semibold text-white">Averis Ecommerce Platform</h1>
                <p className="text-xs text-teal-100 hidden sm:block">Dashboard</p>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSearchSubmit} className="w-full">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-2 border border-teal-500 rounded-md leading-5 bg-teal-500 placeholder-teal-200 text-white focus:outline-none focus:placeholder-teal-100 focus:ring-1 focus:ring-teal-400 focus:border-teal-400 sm:text-sm"
                  placeholder="Search services, APIs, health status..."
                  type="search"
                />
              </div>
            </form>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-lg text-white hover:text-teal-100 hover:bg-teal-700 transition-colors"
            ...
            {isAuthenticated && userProfile ? (
              <div className="relative" ref={profileMenuRef}>
                <button
                  ...
                  className="flex items-center space-x-3 px-3 py-2 w-[250px] bg-teal-500 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-400 focus:ring-offset-teal-600 hover:bg-teal-400"
                >
