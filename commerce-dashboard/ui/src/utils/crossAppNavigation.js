 ...
 * @param {string} appKey - The target application key (product, pricing, customer, averis_ecomm)
...
export const navigateToApp = (appKey, path = '/', openInNewTab = false) => {
  ...
  targetUrl.searchParams.set('source', 'dashboard')
...
export const navigateToProductMdm = (path = '/', openInNewTab = false) => navigateToApp('product', path, openInNewTab)
export const navigateToPricingMdm = (path = '/', openInNewTab = false) => navigateToApp('pricing', path, openInNewTab)
export const navigateToCustomerMdm = (path = '/', openInNewTab = false) => navigateToApp('customer', path, openInNewTab)
export const navigateToEcommerce = (path = '/', openInNewTab = false) => navigateToApp('averis_ecomm', path, openInNewTab)
export const navigateToOms = (path = '/', openInNewTab = false) => navigateToApp('oms', path, openInNewTab)
export const navigateToErp = (path = '/', openInNewTab = false) => navigateToApp('erp', path, openInNewTab)
