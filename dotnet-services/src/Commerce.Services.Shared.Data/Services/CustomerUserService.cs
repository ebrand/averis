...
/// <summary>
/// Service implementation for Customer User business logic operations
/// Handles validation, mapping, and coordination for customer_mdm schema
/// </summary>
public class CustomerUserService : ICustomerUserService
{
    ...
    public CustomerUserService(ICustomerUserRepository userRepository, ILogger<CustomerUserService> logger)
    {
    ...
    public async Task<UserDto> CreateUserAsync(CreateUserRequest request, string? createdByUser = null)
    {
        ...
        _logger.LogInformation("Created user with ID: {UserId} in customer_mdm", createdUser.Id);
    ...
    public async Task<UserDto?> UpdateUserAsync(int id, UpdateUserRequest request, string? updatedByUser = null)
    {
        ...
        {
            _logger.LogWarning("User not found for update in customer_mdm: {UserId}", id);
            return null;
        }
        ...
        _logger.LogInformation("Updated user: {UserId} in customer_mdm", id);
        return updatedUser != null ? MapToDto(updatedUser) : null;
    }

    public async Task<bool> DeleteUserAsync(int id)
    {
        _logger.LogInformation("Deleting user from customer_mdm: {UserId}", id);
    ...
    {
        _logger.LogInformation("Getting available roles for customer_mdm");
        ...
        {
            // Product MDM Roles
            new() { Role = "product_mdm", Description = "General Product MDM Access", Category = "Product MDM", IsApprovalRole = false },
            ...
            // Pricing MDM Roles
            new() { Role = "pricing_mdm", Description = "General Pricing MDM Access", Category = "Pricing MDM", IsApprovalRole = false },
            new() { Role = "pricing_analyst", Description = "Pricing Analyst", Category = "Pricing MDM", IsApprovalRole = false },
            new() { Role = "pricing_manager", Description = "Pricing Manager", Category = "Pricing MDM", IsApprovalRole = false },
            new() { Role = "pricing_approve", Description = "Pricing Approver", Category = "Pricing MDM", IsApprovalRole = true },

            // E-commerce Roles
            new() { Role = "ecommerce_manager", Description = "E-commerce Manager", Category = "E-commerce", IsApprovalRole = false },
            new() { Role = "catalog_manager", Description = "Catalog Manager", Category = "E-commerce", IsApprovalRole = false },
            new() { Role = "catalog_amer", Description = "Catalog Manager - Americas", Category = "E-commerce", IsApprovalRole = false },
            new() { Role = "catalog_emea", Description = "Catalog Manager - EMEA", Category = "E-commerce", IsApprovalRole = false },

            // Inventory MDM Roles
            new() { Role = "inventory_analyst", Description = "Inventory Analyst", Category = "Inventory MDM", IsApprovalRole = false },
            new() { Role = "inventory_manager", Description = "Inventory Manager", Category = "Inventory MDM", IsApprovalRole = false },

            // ERP Roles
            new() { Role = "erp_user", Description = "ERP User", Category = "ERP", IsApprovalRole = false },
            new() { Role = "erp_admin", Description = "ERP Administrator", Category = "ERP", IsApprovalRole = false },
    ...
    public async Task<(bool IsValid, List<string> Errors)> ValidateUserAsync(CreateUserRequest request, int? userId = null)
    {
        ...
        else
        {
            ...
            var validRoles = availableRoles.Roles.Select(r => r.Role).ToList();
