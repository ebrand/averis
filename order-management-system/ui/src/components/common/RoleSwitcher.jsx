  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center justify-between px-3 py-2 rounded-lg bg-blue-700 border border-blue-600 hover:border-blue-500 transition-colors w-[250px]"
      >
        ...
        <ChevronDownIcon className="h-4 w-4 text-blue-300 mr-1" />
      </button>
