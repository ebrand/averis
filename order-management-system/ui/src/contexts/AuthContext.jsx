...
export const AuthProvider = ({ children }) => {
  ...
  const initializeAuth = async () => {
    try {
      ...
      console.log('Order Management System AuthContext: initializeAuth starting')
      console.log('Order Management System AuthContext: Logout URL parameter:', logoutParam)
      
      // If logout parameter exists, FORCE logout immediately regardless of other state
      if (logoutParam) {
        console.log('Order Management System AuthContext: FORCED LOGOUT - Logout parameter detected, clearing all session data')
        ...
        // Clean up the URL
        console.log('Order Management System AuthContext: Cleaning logout parameter from URL')
        const cleanUrl = window.location.origin + window.location.pathname
        window.history.replaceState({}, document.title, cleanUrl)
        
        setIsLoading(false)
        console.log('Order Management System AuthContext: FORCED LOGOUT COMPLETE - staying logged out')
        return
      }
      ...
      console.log('Order Management System AuthContext: Comprehensive logout detection:', { 
        recentLogout, 
        forcedLogout, 
        permanentLogout,
      ...
      if (recentLogout || forcedLogout || permanentLogout) {
        console.log('Order Management System AuthContext: LOGOUT DETECTED - preventing authentication restoration')
        ...
        setIsLoading(false)
        console.log('Order Management System AuthContext: LOGOUT PREVENTION COMPLETE - staying logged out')
        return
      }
      
      // First, process any incoming authentication tokens from URL parameters
      const authResult = processIncomingAuth()
      if (authResult.tokenReceived) {
        console.log('Order Management: Processed incoming authentication token from', authResult.source)
      }
