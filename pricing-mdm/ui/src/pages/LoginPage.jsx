...
import { BuildingOfficeIcon, ShieldCheckIcon, CubeIcon, ChartBarIcon } from '@heroicons/react/24/outline'
  ...
  const features = [
    {
      ...
      description: 'Centralized pricing catalog with comprehensive data management'
    },
    {
      icon: ChartBarIcon,
      title: 'Analytics & Insights',
      description: 'Advanced reporting and business intelligence for pricing data'
    },
    {
      icon: ShieldCheckIcon,
      title: 'Enterprise Security',
      description: 'Role-based access control and audit trails for compliance'
    }
  ]
      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div className="text-center px-2 mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Averis Pricing</h1>
            <p className="text-lg text-gray-600 mt-2">Master Data Management Platform</p>
        ...
        <div className="relative h-full flex flex-col justify-center px-12">
          <div className="text-center text-white mb-12">
            <h2 className="text-4xl font-bold mb-4">
              Enterprise Pricing Data Management
            </h2>
            <p className="text-xl text-green-100">
              Streamline your pricing operations with comprehensive data management tools
            </p>
          </div>
          ...
          <div className="mt-12 text-center text-green-100">
            <p className="text-sm">
              Trusted by enterprise teams worldwide for critical product data management
            </p>
          </div>
        </div>
      </div>
