...
export const DashboardPage = () => {
  ...
  const { isUserAdmin, isAdmin, canViewCatalogs, canViewPricing } = useRole()
  ...
  const quickActions = [
    ...(canViewCatalogs() ? [
      { name: 'View Catalogs', href: '/catalogs/amer', icon: CubeIcon, color: 'blue' }
    ] : []),
    ...(canViewPricing() ? [
      { name: 'View Pricing', href: '/pricing/amer', icon: CurrencyDollarIcon, color: 'green' }
    ] : []),
    ...(isUserAdmin() || isAdmin() ? [
  ...
  const getStatBgColor = (color) => {
    const colors = {
      blue: 'bg-green-50 dark:bg-green-900/20',
                    ...
                    <div className="flex items-center space-x-3">
                      <div className="flex-shrink-0">
                        <div className="h-8 w-8 bg-green-100 rounded-full flex items-center justify-center">
                          <div className="h-2 w-2 bg-green-800 rounded-full" />
                        </div>
                      </div>
                      <div>
                ...
                <>
                  ...
                  {systemStatus.components.rabbitMQ?.details && (
                    <div className="text-xs text-gray-500 dark:text-gray-400">
                      ...
                      {systemStatus.components.rabbitMQ.details.consuming ? ' Consuming' : ' Not consuming'}, 
