...
const ApiTest = () => {
  ...
  const testEndpoints = async () => {
    ...
    const endpoints = [
      ...
      'http://localhost:8002/health',  // Direct to API server
      'http://127.0.0.1:8002/health',  // Direct to API server
      'http://localhost:8002/api/products?limit=1',  // Direct to API server
      'http://127.0.0.1:8002/api/products?limit=1'  // Direct to API server
    ]
