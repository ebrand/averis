...
const LaunchTab = ({ formData, onChange, errors, readOnly = false, onLaunch = null, approvals = {} }) => {
  ...
  const isFieldsReady = !!(
    ...
    (formData.base_price !== null && formData.base_price !== undefined && formData.base_price !== '')
  )
  ...
  console.log('LaunchTab - Approval Debug:', {
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center p-4 rounded-lg border border-gray-200 dark:border-gray-600">
            <div className="flex justify-center mb-3">
              <GlobeAltIcon className={`h-8 w-8 ${formData.web_display_flag ? 'text-green-500' : 'text-gray-400'}`} />
            </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center">
            ...
            <span className={`text-sm ${(formData.base_price !== null && formData.base_price !== undefined && formData.base_price !== '') ? 'text-green-700 dark:text-green-300' : 'text-red-700 dark:text-red-300'}`}>
              Base Price: {(formData.base_price !== null && formData.base_price !== undefined && formData.base_price !== '') ? `Complete ($${formData.base_price})` : 'Required'}
            </span>
          </div>
          ...
          <div className="flex items-center">
            ...
            <span className={`text-sm ${allApproved ? 'text-green-700 dark:text-green-300' : 'text-red-700 dark:text-red-300'}`}>
              Departmental Approvals: {allApproved ? 'Complete' : `${approvedCount}/${requiredApprovals.length} approved`}
            </span>
          </div>
        </div>
          ...
          {isLaunched ? (
            ...
            <div className="space-y-4">
              <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                <div className="flex items-start">
                  <RocketLaunchIcon className="h-6 w-6 text-green-600 dark:text-green-400 mr-3 mt-0.5" />
                  <div>
