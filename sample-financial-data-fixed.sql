...
-- Spanish (Spain) financial data - ES VAT 21%
INSERT INTO averis_pricing.product_locale_financials 
(id, product_id, catalog_id, locale_id, local_price, currency_conversion_rate, 
 tax_rate, tax_amount, tax_included_price, regulatory_fees, 
 conversion_date, is_active, created_at, updated_at)
VALUES (
  gen_random_uuid(),
...
-- French (France) financial data - FR VAT 20%
INSERT INTO averis_pricing.product_locale_financials 
(id, product_id, catalog_id, locale_id, local_price, currency_conversion_rate, 
 tax_rate, tax_amount, tax_included_price, regulatory_fees, 
 conversion_date, is_active, created_at, updated_at)
...
-- German (Germany) financial data - DE VAT 19%
INSERT INTO averis_pricing.product_locale_financials 
(id, product_id, catalog_id, locale_id, local_price, currency_conversion_rate, 
 tax_rate, tax_amount, tax_included_price, regulatory_fees, 
 conversion_date, is_active, created_at, updated_at)
...
-- English (US) financial data - US avg sales tax 8.75%
INSERT INTO averis_pricing.product_locale_financials 
(id, product_id, catalog_id, locale_id, local_price, currency_conversion_rate, 
 tax_rate, tax_amount, tax_included_price, regulatory_fees, 
 conversion_date, is_active, created_at, updated_at)
